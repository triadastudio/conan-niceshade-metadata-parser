...
class NiceshadeMetadataParserConan(ConanFile):
    ...
    homepage = "https://github.com/TheSenPie/niceshade"
    description = "Metadata parser for pipelines generated by niceshade(fork)"
    ...
    def _source_commit(self):
        return "44b932d26f16048395a3fc49214102f50d158771"
    ...
    def source(self):
        files.get(self,
                  url="https://github.com/TheSenPie/niceshade/archive/{}.zip".format(self._source_commit),
